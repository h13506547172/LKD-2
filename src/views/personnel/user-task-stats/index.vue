    ...
    <el-row>
        ...
        ><div class="grid-con">
          <div>
            <div class="blockss">
              ...
              <div class="butbox">
                <span class="buttons" :class="{ buttonss: falg }" @click="butn1"
                  >周</span
                >
                <span
                  class="buttons"
                  :class="{ buttonss: falg1 }"
                  @click="butn2"
                  >月</span
                >
                <span
                  class="buttons"
                  :class="{ buttonss: falg2 }"
                  @click="butn3"
                  >年</span
                >
              </div>
      ...
      <el-col :span="7"
        ><div class="grid-co">
          ...
          <div class="butboxr">
            <span class="operate" :class="{ operates: isshow }" @click="button"
              >运营人员</span
            >
            <span
              class="operate"
              :class="{ operates: isshow1 }"
              @click="button1"
              >运营人员</span
            >
          </div>
...
export default {
  ...
  methods: {
    butn1() {
      ;(this.falg = true), (this.falg1 = false), (this.falg2 = false)
      this.StartTime = '2022-8-1'
      this.EndTime = '2022-8-8'
    },
    butn2() {
      ;(this.falg = false), (this.falg1 = true), (this.falg2 = false)
      this.StartTime = '2022-8-1'
      this.EndTime = '2022-9-1'
    },
    butn3() {
      ;(this.falg = false), (this.falg1 = false), (this.falg2 = true)
      this.StartTime = '2022-1-1'
      this.EndTime = '2023-1-1'
    },
    button() {
      this.isshow = true
      this.isshow1 = false
...
.bg-purple-light {
  ...
  margin-right: 20px;
  background-color: rgb(247, 228, 218);
}
// 下面日期弹框
.date {
  width: 260px;
